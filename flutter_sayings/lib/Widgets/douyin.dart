...
class DouYin extends StatelessWidget{
  const DouYin({Key key}): super (key: key);
  @override
...
//TODO:抖音界面原始的bottomNavigationBar
...
//TODO:下面是抖音界面原始的bottomNavigationBar实现方法
...
class BtmContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ListTile(title: Text("Sayings日志",style: TextStyle(color: Colors.white),),
            subtitle: Text(
